...
campos = (codigo,)# é preciso colocar uma vírgula depois do item para configurar que temos uma tupla,caso contrárionão será aceito como uma tupla válida.
